                ...
                <tr key={subscription.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div className="flex space-x-2">
                      <button className="text-[#23a5e3] hover:text-[#1e8fc4]">
                        Modifier
                      </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="border rounded-lg p-6">
            ...
            <div className="mt-4 space-y-2">
              <div className="flex items-center">
                ...
                <span className="text-sm text-gray-600">Jusqu&apos;à 10 utilisateurs</span>
              </div>
              <div className="flex items-center">
                <Check className="h-5 w-5 text-green-500 mr-2" />
                <span className="text-sm text-gray-600">Alertes basiques</span>
              </div>
              <div className="flex items-center">
                <Check className="h-5 w-5 text-green-500 mr-2" />
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm text-gray-400">Analyses avancées</span>
              </div>
              <div className="flex items-center">
                <X className="h-5 w-5 text-red-500 mr-2" />
            ...
            <button className="mt-6 w-full py-2 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300">
              Sélectionner
            </button>
          </div>

          <div className="border rounded-lg p-6 border-[#23a5e3] shadow-md">
            <div className="bg-[#23a5e3] text-white text-xs font-bold uppercase py-1 px-2 rounded-full inline-block mb-2">
              Populaire
            </div>
            ...
            <div className="mt-4 space-y-2">
              <div className="flex items-center">
                <Check className="h-5 w-5 text-green-500 mr-2" />
                <span className="text-sm text-gray-600">Jusqu&apos;à 20 utilisateurs</span>
              </div>
              <div className="flex items-center">
                <Check className="h-5 w-5 text-green-500 mr-2" />
                <span className="text-sm text-gray-600">Alertes avancées</span>
              </div>
              <div className="flex items-center">
                <Check className="h-5 w-5 text-green-500 mr-2" />
                <span className="text-sm text-gray-600">Support par email et téléphone</span>
              </div>
              <div className="flex items-center">
                <Check className="h-5 w-5 text-green-500 mr-2" />
                <span className="text-sm text-gray-600">Analyses basiques</span>
              </div>
              <div className="flex items-center">
                <X className="h-5 w-5 text-red-500 mr-2" />
                <span className="text-sm text-gray-400">Support prioritaire</span>
            ...
            <button className="mt-6 w-full py-2 bg-[#23a5e3] text-white rounded-md hover:bg-[#1e8fc4]">
              Sélectionner
            </button>
          </div>
          ...
          <div className="border rounded-lg p-6">
            ...
            <div className="mt-4 space-y-2">
              <div className="flex items-center">
                <Check className="h-5 w-5 text-green-500 mr-2" />
                <span className="text-sm text-gray-600">Utilisateurs illimités</span>
              </div>
              <div className="flex items-center">
                <Check className="h-5 w-5 text-green-500 mr-2" />
                <span className="text-sm text-gray-600">Alertes personnalisées</span>
              </div>
              <div className="flex items-center">
                <Check className="h-5 w-5 text-green-500 mr-2" />
